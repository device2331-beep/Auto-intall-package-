...
║    ╚══════════════════════════════════════════════════╝  ║
║                                                          ║
║    🔧 Installing: Python, PHP, Pip Packages             ║
║    📦 Extra: curl, wget, git, nano, tree, htop, jq     ║
║                                                          ║
╚══════════════════════════════════════════════════════════╝
...
ইনস্টলেশন শেষে নিচের লোকেশনে লগ পাবেন:

```
logs/install.log   → সব ইনস্টল হওয়া প্যাকেজের বিস্তারিত লগ
logs/error.log     → কোনো এরর হলে সেটার লগ
```
